...
I am a **Backend Developer** specializing in **Laravel (PHP)** and **Golang**, with a strong focus on building scalable, secure, and efficient web applications.  
Additionally, I possess **basic knowledge of Web Application Penetration Testing** and continuously sharpen my cybersecurity skills as an active **TryHackMe (THM) player**.  
